...
parser.add_argument('--teacher', type=str, default='mobilenet_v2', help='path of CIFAR10')
...
def main():
    ...
    # load model
    model_teacher = mobilenet_v2(pretrained=True, device='cuda')
    model_teacher = nn.DataParallel(model_teacher).cuda()
    for p in model_teacher.parameters():
        p.requires_grad = False
    model_teacher.eval()

    model_student = reactnetv2()
